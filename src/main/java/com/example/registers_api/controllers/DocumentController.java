...
public class DocumentController {
    ...
    public ResponseEntity<String> upload(@RequestParam("file") MultipartFile file,
                                         @RequestParam("uploadedBy") String user) throws IOException {
        var fileId = documentService.storeFile(file, user);
    ...
    public ResponseEntity<InputStreamResource> download(@PathVariable String id) throws IOException {
        var resource = documentService.getFileById(id);
    ...
    @GetMapping("/download/by-filename/{filename}")
    public ResponseEntity<InputStreamResource> downloadByFilename(@PathVariable String filename) throws IOException {
        var resource = documentService.getFileByFilename(filename);
